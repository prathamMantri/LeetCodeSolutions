...
public class Solution84 {
    public int largestRectangleArea(int[] heights) {
        ...
        if it is
            keep removing number from stack until you find the number which is less than or equal to current number, while doing so, calculate the area, by below formula
